...
React JS is a javascript library that makes it easier to manipulate the DOM. The problems React tries to solve is how difficult it can be to make big changes to DOM with vanilla javascript.

- [ ] What does it mean to _think_ in react?

Thinking in react means to think of everything in components.

- [ ] Describe state.

State is an object that holds information necessary for the components.

- [ ] Describe props.

Props is how you can share and spread the state amongst all the components. 
